...
class TestImage:
	def __init__(self, headings):
		...
		# First, make sure we're not trying to erase an important attribute
		...
		for each_heading in headings:
			temporary_heading = ""
			if each_heading[0] == "&":
				temporary_heading = each_heading[1:]
			else:
				temporary_heading = each_heading
	...
	def generate_filename(self):
		...
		try:
			# set caption with species names
		except:
			# set caption with species numbers

# the following class is kept around for reference and will be removed
class ColonyImage:
